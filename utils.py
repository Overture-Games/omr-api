...
def run_audiveris(input_filepath):
    ...
    try:
        ...
        # This timeout is always assuming the processing has finished by this point, as there is no way to check for Audiveris finishing processing
        except subprocess.TimeoutExpired:
